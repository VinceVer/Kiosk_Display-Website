...
router.get('/:p1?/:p2?', function(req, res, next) {
	...
	if (session_desktop !== desktopKey) {
		res.render('login', {type: "desktop", cookies: layout})
	} else {
...
router.get('/preferences/:p1?/:p2?', (req, res, next) => {
	let {session_desktop, ...layout} = req.cookies;
	...
	if (session_desktop !== desktopKey) {
		...
		res.render('desktop/preferences', {
			config_data: config_data,
			status_database: status_database,
			cookies: layout
		});
...
router.get('/data/:type/:p1?/:p2?', async function(req, res, next) {
	if (req.params.p1 && req.params.p1 !== "k" && req.params.p1 !== "g") {
		next()
		return;
	}
...
// 	if (session_desktop !== desktopKey) {
// 		res.render('desktop/login', {type: "desktop"});
// 	} else {
// 		res.render('desktop/desktop-schedules-'+req.params.type, {
// 			config_data: config_data,
// 			status_database: status_database,
...
// 		res.render('login', {type: "desktop"})
// 	} else {
// 		res.render('desktop/desktop-data', {
// 			config_data: config_data,
// 			status_database: status_database,
// 			misc_data: misc_data,
// 			layout: layout
...
// 		} else {
// 			res.render('desktop/desktop-infographics', {
// 				config_data: config_data,
// 				status_database: status_database,
// 				misc_data: misc_data,
// 				layout: layout
...
// 	res.render('desktop/desktop-simple', {
// 		config_data: config_data,
// 		status_database: status_database,
// 		misc_data: misc_data,
// 		layout: layout
